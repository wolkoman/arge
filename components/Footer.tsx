...
export const Footer = ({}) => {
  return (
    <div className="flex flex-col text-sm md:flex-row py-8 px-8 mt-auto print:hidden">
      <div className="flex-1 py-8">
        ...
        Email: office(at)argeschoepfung.at <br />
      ...
      <div className="flex-1 py-8">
        ...
        <Link href="/datenschutz"><div className="underline hover:no-underline cursor-pointer">Datenschutzinformationen</div></Link> informieren wir Sie über die wichtigsten
