...
export default function Spenden({article}) {
  return <Site>
    ...
    <div className="flex flex-col md:flex-row">
      {/* @ts-ignore */ }
      <iframe allowpaymentrequest className="flex-shrink-0 pr-4" src="https://donorbox.org/embed/arge-schopfungsverantwortung?default_interval=o&hide_donation_meter=true"
